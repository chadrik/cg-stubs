...
EXPLICIT_DEFINITIONS = {
    ...
    "SceneViewer": {
        ...
        "selectDynamics": "(self, prompt: str = 'Select objects', sel_index: int = 0, allow_objects: bool = True, allow_modifiers: bool = False, quick_select: bool = False, use_existing_selection: bool = True, allow_multisel: bool = True, icon: Optional[str] = None, label: Optional[str] = None, prior_selection_paths: Optional[Sequence[str]] = ..., prior_selection_ids: Optional[int] = ..., prior_selections: Sequence[str] = ..., toolbox_templategroup: Optional[str] = None, toolbox1_templategroup: Optional[str] = None, select_parm: str = '') -> Sequence[DopData]",
        ...
        "selectObjects": "(self, prompt: str = 'Select objects', sel_index: int = 0, allow_drag: bool = False, quick_select: bool = False, use_existing_selection: bool = True, allow_multisel: bool = True, allowed_types: Sequence[str] = ..., icon: Optional[str] = None, label: Optional[str] = None, prior_selection_paths: Optional[Sequence[str]] = ..., prior_selection_ids: Optional[int] = ..., prior_selections: Sequence[str] = ..., toolbox_templategroup: Optional[str] = None, toolbox1_templategroup: Optional[str] = None, select_parm: str = '') -> Sequence[Node]",
