...
# WARNING: mypy.stubdoc._TYPE_RE must be updated from the chadrik branch to a more recent version.
#  The correct pattern is: re.compile(r"^[a-zA-Z_][\w\[\], .\"\']*(\.[a-zA-Z_][\w\[\], ]*)*$")
...
EXPLICIT_DEFINITIONS = {
    ...
    "AgentLayer": {
        ...
        "bindings": "(self, transform: Optional[int] = None) -> Tuple[AgentShapeBinding, ...]",
    },
    "AgentMetadata": {
    ...
    "Cop2Node": {
        "allPixels": "(self, plane: str = 'C', component: Optional[str] = None, interleaved: bool = True, time: float = -1.0) -> Tuple[float, ...]",
    ...
    "Face": {
        "attribValueAt": "(self, attrib_or_name: Union[Attrib, str], u: float, du: float = 0) -> Union[int, float, str, Tuple[int, ...], Tuple[float, ...]]"
    },
    "FlipbookSettings": {
    ...
    "Geometry": {
        ...
        "attribValue": "(self, name_or_attrib: Union[str, Attrib]) -> Union[int, float, str, Tuple[int, ...], Tuple[float, ...], Dict[str, Any]]",
        ...
        "createPolygons": "(self, point_positions: Sequence[Union[Point, Sequence[int]]], is_closed: bool = True) -> Tuple[Polygon, ...]",
        ...
        "floatListAttribValue": "(self, name_or_attrib: Union[str, Attrib]) -> Tuple[float, ...]",
        "generateAttribMenu": "(self, attrib_type: Optional[EnumValue] = None, data_type: Optional[EnumValue] = None, min_size: int = 1, max_size: int = -1, array_type: bool = True, scalar_type: bool = True, case_sensitive: bool = True, pattern: str = '*', decode_tokens: bool = False) -> Tuple[str, ...]",
        ...
        "intListAttribValue": "(self, name_or_attrib: Union[Attrib, str]) -> Tuple[int, ...]",
        ...
        "stringListAttribValue": "(self, name_or_attrib: Union[Attrib, str]) -> Tuple[str, ...]",
    ...
    "HDADefinition": {
        ...
        "setExtraFileOption": "(self, name, value: Union[int, float, str, Vector2, Vector3, Vector4, Quaternion, Matrix3, Matrix4, Sequence[float]], type_hint: EnumValue = fieldType.NoSuchField) -> None",
    },
    "HDASection": {
    ...
    "LopNode": {
        ...
        "layersAboveLayerBreak": "(self, output_index: int = 0, use_last_cook_context_options: bool = True, frame: Optional[float] = None, context_options: Optional[Dict[str, Union[str, float]]] = None) -> Tuple[str, ...]",
    ...
    "ObjNode": {
        "material": "(self, operation: Literal['override', 'select', 'remove', 'rmdefault', 'sync', 'revert', 'addlist'], parameter: Optional[Sequence[str]] = None) -> None",
    },
    "OpNode": {
    ...
    "ParmTemplateGroup": {
        ...
        "containingFolderIndices": "(self, name_or_parm_template_or_indices: Union[str, ParmTemplate, Sequence[int]]) -> Tuple[int, ...]",
        "findFolder": "(self, label_or_labels: Union[str, Sequence[str]]) -> Optional[ParmTemplate]",
        "findIndices": "(self, name_or_parm_template: Union[ParmTemplate, str]) -> Tuple[int, ...]",
        "findIndicesForFolder": "(self, name_or_parm_template: Union[ParmTemplate, str]) -> Tuple[int, ...]",
    ...
    "Point": {
        "attribValue": "(self, attrib: Union[Attrib, str]) -> Union[int, float, str, Tuple[int, ...], Tuple[float, ...], Dict[str, Any]]",
        ...
        "intListAttribValue": "(self, name_or_attrib: Union[str, Attrib]) -> Tuple[int, ...]",
        ...
        "stringListAttribValue": "(self, name_or_attrib: Union[str, Attrib]) -> Tuple[str, ...]",
    },
    "PointGroup": {
    ...
    "Prim": {
        "attribValue": "(self, attrib: Union[Attrib, str]) -> Union[int, float, str, Tuple[int, ...], Tuple[float, ...], Dict[str, Any]]",
        "attribValueAtInterior": "(self, attrib: Union[Attrib, str], u: float, v: float, w: float = 0.0) -> Union[int, float, str, Tuple[int, ...], Tuple[float, ...]]",
        "dictAttribValue": "(self, attrib: Union[Attrib, str]) -> Dict[str, Any]",
        "dictListAttribValue": "(self, name_or_attrib: Union[Attrib, str]) -> Sequence[dict[str, Any]]",
    ...
    "SceneViewer": {
        ...
        "selectDynamics": "(self, prompt: str = 'Select objects', sel_index: int = 0, allow_objects: bool = True, allow_modifiers: bool = False, quick_select: bool = False, use_existing_selection: bool = True, allow_multisel: bool = True, icon: Optional[str] = None, label: Optional[str] = None, prior_selection_paths: Optional[Sequence[str]] = ..., prior_selection_ids: Optional[int] = ..., prior_selections: Sequence[str] = ..., toolbox_templategroup: Optional[str] = None, toolbox1_templategroup: Optional[str] = None, select_parm: str = '') -> Tuple[DopData, ...]",
        "selectDynamicsPoints": "(self, prompt: str = 'Select objects', sel_index: int = 0, quick_select: bool = False, use_existing_selection: bool = True, allow_multisel: bool = True, only_select_points: bool = True, object_based_point_selection: bool = False, use_last_selected_object: bool = False, icon: Optional[str] = None, label: Optional[str] = None, prior_selection_paths: Optional[Sequence[str]] = ..., prior_selection_ids: Optional[int] = ..., prior_selections: Sequence[str] = ..., toolbox_templategroup: Optional[str] = None, toolbox1_templategroup: Optional[str] = None, select_parm: str = '') -> Sequence[tuple[DopData, GeometrySelection]]",
        "selectDynamicsPolygons": "(self, prompt: str = 'Select objects', sel_index: int = 0, quick_select: bool = False, use_existing_selection: bool = True, object_based_point_selection: bool = False, use_last_selected_object: bool = False, icon: Optional[str] = None, label: Optional[str] = None, prior_selection_paths: Optional[Sequence[str]] = ..., prior_selection_ids: Optional[int] = ..., prior_selections: Sequence[str] = ..., toolbox_templategroup: Optional[str] = None, toolbox1_templategroup: Optional[str] = None, select_parm: str = '') -> Sequence[tuple[DopData, GeometrySelection]]",
        ...
        "selectObjects": "(self, prompt: str = 'Select objects', sel_index: int = 0, allow_drag: bool = False, quick_select: bool = False, use_existing_selection: bool = True, allow_multisel: bool = True, allowed_types: Sequence[str] = ..., icon: Optional[str] = None, label: Optional[str] = None, prior_selection_paths: Optional[Sequence[str]] = ..., prior_selection_ids: Optional[int] = ..., prior_selections: Sequence[str] = ..., toolbox_templategroup: Optional[str] = None, toolbox1_templategroup: Optional[str] = None, select_parm: str = '') -> Tuple[Node, ...]",
    ...
    "Surface": {
        "attribValueAt": "(self, attrib_or_name: Union[Attrib, str], u: float, v: float, du: float = 0, dv: float = 0) -> Union[int, float, str, Tuple[int, ...], Tuple[float, ...]]"
    },
    "SwigPyIterator": {
    ...
    "hmath": {
        ...
        "buildTransform": "(values_dict: dict[str, Union[Vector3, Sequence[float]]], transform_order: Literal['srt', 'str', 'rst', 'rts', 'tsr', 'trs'] = 'srt', rotate_order: Literal['xyz', 'xzy', 'yxz', 'yzx', 'zxy', 'zyx'] = 'xyz') -> Matrix4",
    ...
    "hotkeys": {
        ...
        "availableKeycodes": "(context: str, hotkey_symbol: str, layout_keys: Optional[Sequence[str]] = None, modifiers: int = 0) -> Tuple[int, ...]",
        "clearAssignments": "(context: str, hotkey_symbol: str) -> bool",
        "findConflicts": "(context: str, hotkey_symbol: str, key: Optional[str] = None) -> Tuple[str, ...]",
    ...
    "properties": {
        "classes": "(tags: Optional[Sequence[str]] = None) -> Tuple[str, ...]",
    },
    "shelves": {
    ...
    "ui": {
        ...
        "displayFileDependencyDialog": "(rop_node: Optional[RopNode] = None, uploaded_files: Sequence[str] = ..., forced_unselected_patterns: Sequence[str] = ..., project_dir_variable: str = 'HIP', is_standalone: bool = true) -> Tuple[bool, Tuple[Tuple[Parm, str], ...]]",
        ...
        "loadPackageArchive": "(file_path: str, extract_path: Optional[str] = None) -> Tuple[str, ...]",
        ...
        "readMultiInput": "(text: str, input_labels: Sequence[str], password_input_indices: Sequence[int] = ..., buttons: Sequence[str] = ..., severity_type: EnumValue = ..., default_choice: int = 0, close_choice: int = -1, help: Optional[str] = None, title: Optional[str] = None, initial_contents: Sequence[str] = ...) -> Tuple[int, Tuple[str, ...]]",
        "reloadViewerStates": "(state_names: Optional[Sequence[str]] = None) -> None",
        "selectFromList": "(choices: Sequence[str], default_choices: Sequence[int] = ..., exclusive: bool = False, message: Optional[str] = None, title: Optional[str] = None, column_header: str = 'Choices', num_visible_rows: int = 10, clear_on_cancel: bool = False, width: int = 0, height: int = 0, sort: bool = False, condense_paths: bool = False) -> Tuple[int, ...]",
        "selectFromTree": "(choices: Sequence[str], picked: Sequence[int] = ..., exclusive: bool = False, message: Optional[str] = None, title: Optional[str] = None, clear_on_cancel: bool = False, width: int = 0, height: int = 0) -> Tuple[str, ...]",
        "selectParm": "(category: NodeTypeCategory = ..., bound_parms_only: bool = False, relative_to_node: Optional[OpNode] = None, message: Optional[str] = None, title: Optional[str] = None, initial_parms: Sequence[Parm] = ..., multiple_select: bool = True, width: int = 0, height: int = 0) -> Tuple[str, ...]",
        "selectParmTuple": "(category: NodeTypeCategory = ..., bound_parms_only: bool = False, relative_to_node: Optional[OpNode] = None, message: Optional[str] = None, title: Optional[str] = None, initial_parm_tuples: Sequence[ParmTuple] = ..., multiple_select: bool = True, width: int = 0, height: int = 0) -> Tuple[str, ...]",
    ...
    "viewportVisualizers": {
        ...
        "visualizers": "(category: EnumValue = viewportVisualizerCategory.Common, node: Optional[Node] = None) -> Tuple[ViewportVisualizer, ...]",
    },
}
