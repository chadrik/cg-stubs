...
class QAbstractItemModel(QObject):
    ...
    layoutChanged: typing.ClassVar[Signal[tuple[()]]] = ...
    modelAboutToBeReset: typing.ClassVar[Signal[tuple[()], tuple[typing.Any, PySide6.QtCore.QAbstractItemModel.LayoutChangeHint], tuple[typing.Any]]] = ...  # type: ignore[name-defined]
...
class QObject(shiboken6.Object):
    destroyed: typing.ClassVar[Signal[tuple[()]]] = ...
...
class QProcess(QIODevice):
    ...
    finished: typing.ClassVar[Signal[tuple[int, PySide6.QtCore.QProcess.ExitStatus]]] = ...  # type: ignore[name-defined]
...
class QSocketNotifier(QObject):
    class Type(enum.Enum):
        ...
        Read = 0
        Write = 1
    activated: typing.ClassVar[Signal[tuple[PySide6.QtCore.QSocketDescriptor, PySide6.QtCore.QSocketNotifier.Type]]] = ...  # type: ignore[name-defined]
    staticMetaObject: typing.ClassVar[QMetaObject] = ...
    @typing.overload
...
class Signal(typing.Generic[*_SignalSignatures]):
    ...
    @typing.overload
    def __init__(self: Signal[tuple[T1], tuple[T3]], /, types: tuple[type[T1]], types2: tuple[type[T3]], name: str | None = ..., arguments: Optional[List[str]] = ...) -> None: ...
    @typing.overload
    def __init__(self: Signal[tuple[T1, T2], tuple[T3]], /, types: tuple[type[T1], type[T2]], types2: tuple[type[T3]], name: str | None = ..., arguments: Optional[List[str]] = ...) -> None: ...
    @typing.overload
    def __init__(self: Signal[tuple[T1], tuple[T3, T4]], /, types: tuple[type[T1]], types2: tuple[type[T3], type[T4]], name: str | None = ..., arguments: Optional[List[str]] = ...) -> None: ...
    @typing.overload
    def __init__(self: Signal[tuple[T1, T2], tuple[T3, T4]], /, types: tuple[type[T1], type[T2]], types2: tuple[type[T3], type[T4]], name: str | None = ..., arguments: Optional[List[str]] = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    @typing.overload
    def __getitem__(self: Signal[tuple[T1], *_SignalSignatures1], index: type[T1]) -> SignalInstance[tuple[T1]]: ...
    @typing.overload
    def __getitem__(self: Signal[tuple[T1, T2], *_SignalSignatures1], index: tuple[type[T1], type[T2]]) -> SignalInstance[tuple[T1, T2]]: ...
    @typing.overload
    def __getitem__(self: Signal[tuple[T1, T2, T3], *_SignalSignatures1], index: tuple[type[T1], type[T2], type[T3]]) -> SignalInstance[tuple[T1, T2, T3]]: ...
    @typing.overload
    def __getitem__(self: Signal[*_SignalSignatures1, tuple[T1]], index: type[T1]) -> SignalInstance[tuple[T1]]: ...
    @typing.overload
    def __getitem__(self: Signal[*_SignalSignatures1, tuple[T1, T2]], index: tuple[type[T1], type[T2]]) -> SignalInstance[tuple[T1, T2]]: ...
    @typing.overload
    def __getitem__(self: Signal[*_SignalSignatures1, tuple[T1, T2, T3]], index: tuple[type[T1], type[T2], type[T3]]) -> SignalInstance[tuple[T1, T2, T3]]: ...
    @typing.overload
    def __getitem__(self, index: tuple[type, ...]) -> SignalInstance: ...

class SignalInstance(typing.Generic[*_SignalSignatures]):
    @typing.overload
    def connect(self: SignalInstance[tuple[T1, *_SignalArgT], *_SignalSignatures], slot: _SlotFunc[()] | _SlotFunc[T1], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[T1, T2, *_SignalArgT], *_SignalSignatures], slot: _SlotFunc[T1, T2], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    def connect(self: SignalInstance[tuple[T1, T2, T3, *_SignalArgT], *_SignalSignatures], slot: _SlotFunc[T1, T2, T3], /, type: Qt.ConnectionType = ...) -> QMetaObject.Connection: ...
    @typing.overload
    ...
    def __call__(self, *args, **kwargs): ...
    @typing.overload
    def __getitem__(self: SignalInstance[tuple[T1], *_SignalSignatures1], index: type[T1]) -> SignalInstance[tuple[T1]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[tuple[T1, T2], *_SignalSignatures1], index: tuple[type[T1], type[T2]]) -> SignalInstance[tuple[T1, T2]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[tuple[T1, T2, T3], *_SignalSignatures1], index: tuple[type[T1], type[T2], type[T3]]) -> SignalInstance[tuple[T1, T2, T3]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[*_SignalSignatures1, tuple[T1]], index: type[T1]) -> SignalInstance[tuple[T1]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[*_SignalSignatures1, tuple[T1, T2]], index: tuple[type[T1], type[T2]]) -> SignalInstance[tuple[T1, T2]]: ...
    @typing.overload
    def __getitem__(self: SignalInstance[*_SignalSignatures1, tuple[T1, T2, T3]], index: tuple[type[T1], type[T2], type[T3]]) -> SignalInstance[tuple[T1, T2, T3]]: ...
    @typing.overload
    def __getitem__(self, index: tuple[type, ...]) -> SignalInstance: ...
